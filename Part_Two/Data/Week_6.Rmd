...
library(tidyverse)
library(knitr)
country_time <- read_csv("country_timeseries.csv")
head(country_time, n = 3)
mex_deaths <- read_csv("mexico_deaths.csv")
head(mex_deaths, n = 3)
mex_exp <- read_csv("mexico_exposure.csv")
head(mex_exp, n = 3)
```
...
library(dplyr)
library(ggplot2)
ebola <- read_csv("country_timeseries.csv")
